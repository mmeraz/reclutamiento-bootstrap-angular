...
@Component({
  selector: 'app-baja-asignadas',
  templateUrl: './baja-asignadas.component.html',
  styles: []
})
export class BajaAsignadasComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimientoSolicitudAsignadaByPrioridad('Baja').subscribe(result => {
