...
@Component({
  selector: 'app-alta-asignadas',
  templateUrl: './alta-asignadas.component.html',
  styles: []
})
export class AltaAsignadasComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimientoSolicitudAsignadaByPrioridad('Alta').subscribe(result => {
