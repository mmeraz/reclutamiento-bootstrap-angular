...
@Component({
  selector: 'app-media-asignadas',
  templateUrl: './media-asignadas.component.html',
  styles: []
})
export class MediaAsignadasComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimientoSolicitudAsignadaByPrioridad('Media').subscribe(result => {
