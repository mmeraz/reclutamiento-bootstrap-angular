...
@Component({
  selector: 'app-baja-perdidos',
  templateUrl: './baja-perdidos.component.html',
  styles: []
})
export class BajaPerdidosComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimietoXPerdidas('Baja').subscribe(result => {
