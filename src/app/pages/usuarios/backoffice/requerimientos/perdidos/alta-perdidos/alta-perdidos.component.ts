...
@Component({
  selector: 'app-alta-perdidos',
  templateUrl: './alta-perdidos.component.html',
  styles: []
})
export class AltaPerdidosComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimietoXPerdidas('Alta').subscribe(result => {
