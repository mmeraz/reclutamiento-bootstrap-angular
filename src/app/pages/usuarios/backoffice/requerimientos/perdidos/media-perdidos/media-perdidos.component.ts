...
@Component({
  selector: 'app-media-perdidos',
  templateUrl: './media-perdidos.component.html',
  styles: []
})
export class MediaPerdidosComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimietoXPerdidas('Media').subscribe(result => {
