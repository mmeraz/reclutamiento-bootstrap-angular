...
@Component({
  selector: 'app-alta-pend-respuesta',
  templateUrl: './alta-pend-respuesta.component.html',
  styles: []
})
export class AltaPendRespuestaComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimientoPendientePrioridad('Alta').subscribe(result => {
