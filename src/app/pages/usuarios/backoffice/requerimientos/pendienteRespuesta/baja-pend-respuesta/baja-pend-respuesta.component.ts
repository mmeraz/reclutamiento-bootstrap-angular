...
@Component({
  selector: 'app-baja-pend-respuesta',
  templateUrl: './baja-pend-respuesta.component.html',
  styles: []
})
export class BajaPendRespuestaComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimientoPendientePrioridad('Baja').subscribe(result => {
