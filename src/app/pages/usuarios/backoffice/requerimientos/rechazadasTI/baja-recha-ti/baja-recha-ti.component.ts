...
@Component({
  selector: 'app-baja-recha-ti',
  templateUrl: './baja-recha-ti.component.html',
  styles: []
})
export class BajaRechaTiComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimietoRechazadasTI('Baja').subscribe(result => {
