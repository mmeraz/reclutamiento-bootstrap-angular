...
@Component({
  selector: 'app-media-recha-ti',
  templateUrl: './media-recha-ti.component.html',
  styles: []
})
export class MediaRechaTiComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimietoRechazadasTI('Media').subscribe(result => {
