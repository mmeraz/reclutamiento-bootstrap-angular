...
@Component({
  selector: 'app-alta-pend-ti',
  templateUrl: './alta-pend-ti.component.html',
  styles: []
})
export class AltaPendTiComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimientoSolicitudesXValidar('Alta').subscribe(result => {
