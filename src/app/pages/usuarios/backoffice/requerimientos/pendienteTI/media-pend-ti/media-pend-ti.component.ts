...
@Component({
  selector: 'app-media-pend-ti',
  templateUrl: './media-pend-ti.component.html',
  styles: []
})
export class MediaPendTiComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.serviceSolicitud.getSgsSeguimientoSolicitudesXValidar('Media').subscribe(result => {
