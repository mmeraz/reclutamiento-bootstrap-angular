...
@Component({
  selector: 'app-candidatopendientevaliti',
  templateUrl: './candidatopendientevaliti.component.html',
  styles: []
})
export class CandidatopendientevalitiComponent implements OnInit {
