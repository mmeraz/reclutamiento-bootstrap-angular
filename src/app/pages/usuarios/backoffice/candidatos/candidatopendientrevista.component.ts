...
@Component({
  selector: 'app-candidatopendientrevista',
  templateUrl: './candidatopendientrevista.component.html',
  styles: []
})
export class CandidatopendientrevistaComponent implements OnInit {
