...
@Component({
  selector: 'app-candiaceplider',
  templateUrl: './candiaceplider.component.html',
  styles: []
})
export class CandiacepliderComponent implements OnInit {
...
this.serviceSecCandidato.getSecSeguimientoAceptado().subscribe(result => {
